	...
	<table class="table table-bordered table-hover sortable">
		<thead>
			<tr>
				...
				<th class="nowrap"><g:message code="drinkLog.beer.label" default="Beer" /></th>

				<th class="nowrap"><g:message code="drinkLog.date.label" default="Date" /></th>

				<th class="nowrap"><g:message code="drinkLog.user.label" default="User" /></th>
